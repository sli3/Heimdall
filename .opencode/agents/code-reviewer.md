---
description: Deep read-only code reviewer. Reviews a named function against AGENTS.md, latest session memo, and the file itself. Invoke with @code-reviewer review [function] in [file].
mode: subagent
